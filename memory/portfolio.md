...
- Tape refreshed to 5/27 closes (see watchlist). Key moves since the
  stale 5/21 prints: NVDA $219→$212 (deeper post-print digestion =
  cheaper entry), AMD $449→$495 (+10%, now above prior entry zone),
  IONQ $58.87→$65 (still extended), QTUM $149→$156.
- Macro today: **April PCE (Fed's preferred inflation gauge) + Q1 GDP
  2nd reading release this morning.** March PCE ran hot (3.5% headline /
  3.2% core); a hot April print is a rate-cut headwind. Treat as a
  tier-1 print — stage any entries AFTER the data to avoid the pre-print
  blackout window.
- Action items for next session:
  1. If executing, lead with SPY + QQQ index starters (5% each) — no
     single-name binary risk — after the PCE print clears.
  2. QTUM starter in two tranches (~2.5% near $156, ~2.5% on dip ~$152).
  3. NVDA starter (5%) at $208–214; better entry than 5/21.
  4. AMD: do NOT chase $495; wait for pullback to ~$470–480 or take a
     half-size starter only.
  5. New high-conviction growth: PLTR (3–5%, ~$133) and NBIS (3%,
     small-cap, ~$208) cleared on fundamentals; both report passed.
  6. RGTI small-cap quantum starter (3%) as a direct grant-recipient
     complement to QTUM.
  7. IONQ stays hold-off (trigger $50–52). KTOS/SOFI need a deeper dive
     before sizing.
