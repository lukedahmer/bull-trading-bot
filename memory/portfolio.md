...
- Benchmark (SPY) Return Since Start: tape ~+0.21% cumulative over the last three sessions (−0.79% on 5/19, +0.92% on 5/20, +0.08% on 5/21); Dexter baseline still TBD on first SPY purchase
...
- Reserve 10% for high-conviction opportunities
